...
import { User, Mail, Phone, Lock, UploadCloud, ShieldCheck, Check, Camera, Image as ImageIcon, Briefcase, Building } from "lucide-react";
...
export const StaffProfile = () => {
    ...
    // Cover Photo State
    const [coverPhoto, setCoverPhoto] = useState(() => localStorage.getItem("staff-cover-photo") || "");
    ...
    const selectPredefinedCover = (value) => {
        setCoverPhoto(value);
        localStorage.setItem("staff-cover-photo", value);
        setIsEditingCover(false);
    };

    const removeCoverPhoto = () => {
        setCoverPhoto("");
        localStorage.removeItem("staff-cover-photo");
        setIsEditingCover(false);
    };
    ...
    const handleCoverChange = (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                localStorage.setItem("staff-cover-photo", base64String);
                setIsEditingCover(false);
            };
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300 w-full">
            ...
            <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl shadow-xl overflow-hidden">
                ...
                >
                    {coverPhoto ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-r from-blue-900/40 via-[#111] to-purple-900/40" />
                    )}
                        ...
                        <div className="absolute inset-0 bg-black/95 backdrop-blur-sm z-30 flex flex-col items-center justify-center p-4 animate-in fade-in duration-200" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="bg-blue-500 hover:bg-blue-400 text-white px-3.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1.5 cursor-pointer border-none"
                                >
                ...
                <div className="px-6 sm:px-10 pb-8 flex flex-col sm:flex-row items-center sm:items-end gap-6 -mt-16 relative">
                    ...
                    <div className="relative group">
                        ...
                        <div 
                            onClick={triggerFileInput}
                            className="absolute bottom-2 right-0 w-8 h-8 bg-blue-500 rounded-full border-4 border-[#1a1a1a] flex items-center justify-center cursor-pointer hover:scale-110 transition-transform shadow-lg shadow-blue-500/20"
                        >
                    ...
                    <div className="flex items-center gap-3 pb-3">
                        <div className="px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-lg inline-flex items-center gap-2 text-blue-400 text-sm font-bold uppercase tracking-wider">
                            <Briefcase className="w-4 h-4" /> {user?.role || "staff"}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* Column 1: Profile Information & Editing */}
                <div className="space-y-8 flex flex-col">
                    
                    {/* Employment Details (Read Only) */}
                    <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl shadow-xl overflow-hidden p-8">
                        <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-6 flex items-center gap-2">
                            <Building className="w-4 h-4 text-blue-500" /> Employment Record
                        </h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 text-gray-300 font-medium">
                                    <Building className="w-4 h-4 text-gray-500" /> {user?.department || "—"}
                                </div>
                            </div>
                            <div>
                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Job Role</p>
                                <div className="flex items-center gap-2 text-gray-300 font-medium">
                                    <Briefcase className="w-4 h-4 text-gray-500" /> {user?.designation || user?.role || "—"}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Edit Profile */}
                    <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl shadow-xl overflow-hidden flex-1">
                        <div className="bg-[#111111] px-8 py-5 border-b border-gray-800 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Update your editable contact information.</p>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-[#1a1a1a] border border-gray-700 text-gray-200 text-base rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-inner" 
                                    />
                                </div>
                            </div>
                            <div>
                ...
                <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl shadow-xl overflow-hidden flex flex-col h-full">
                    <div className="bg-[#111111] px-8 py-5 border-b border-gray-800 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">Ensure your staff account stays secure.</p>
                        </div>
                    </div>
                    ...
                    {/* Form Submit Action inside the card */}
                    <div className="p-8 pt-0 mt-auto">
                         <button 
                            type="submit"
                            disabled={isSaving}
                            className="w-full bg-blue-500 hover:bg-blue-400 text-white px-8 py-3.5 rounded-xl text-base font-bold transition-all shadow-lg shadow-blue-500/20 flex items-center justify-center gap-3 disabled:opacity-70 cursor-pointer"
                        >
                            {isSaving ? (
